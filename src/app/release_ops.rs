...
const SELF_MEMORY_SEEDS: &[SelfMemorySeed] = &[
    SelfMemorySeed {
        ...
        body: "The dukememory. project is the local Rust + SQLite + FTS5 + Rhai memory layer for agent-driven projects. It stores durable product intent, decisions, preferences, commands, task state, constraints, and notes.",
    },
    SelfMemorySeed {
